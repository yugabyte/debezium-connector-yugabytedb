...
public class YugabyteDBTransactionContext extends TransactionContext {
	...
	// private static final String OFFSET_TRANSACTION_ID = TransactionStructMaker.DEBEZIUM_TRANSACTION_KEY
	// 		+ "_" + TransactionStructMaker.DEBEZIUM_TRANSACTION_ID_KEY;
	// private static final String OFFSET_TABLE_COUNT_PREFIX =
	// 	TransactionStructMaker.DEBEZIUM_TRANSACTION_KEY + "_"
