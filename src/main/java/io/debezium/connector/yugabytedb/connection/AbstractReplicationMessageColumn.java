...
public abstract class AbstractReplicationMessageColumn implements ReplicationMessage.Column {
    ...
    public static class TypeMetadataImpl implements ReplicationMessage.ColumnTypeMetadata {
        ...
        public TypeMetadataImpl(String columnName, YugabyteDBType type, String typeWithModifiers, boolean optional) {
    ...
    public AbstractReplicationMessageColumn(String columnName, Common.QLTypePB type) {
        super();
        this.columnName = columnName;
        this.qlTypePB = type;
    ...
    /**
     * @return the {@link YugabyteDBType} containing both OID and JDBC id.
     */
    @Override
    public YugabyteDBType getType() {
        return type;
    }
