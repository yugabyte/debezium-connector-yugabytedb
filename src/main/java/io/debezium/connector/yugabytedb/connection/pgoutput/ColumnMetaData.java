...
public class ColumnMetaData {
     ...
     */
    ColumnMetaData(String columnName, YugabyteDBType yugabyteDBType, boolean key, boolean optional, boolean hasDefaultValue, Object defaultValue, int typeModifier) {
