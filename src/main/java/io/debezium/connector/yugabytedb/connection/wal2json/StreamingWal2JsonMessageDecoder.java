...
public class StreamingWal2JsonMessageDecoder extends AbstractMessageDecoder {
        ...
        try {
            ...
            if (!messageInProgress) {
                ...
                if (firstChar != LEFT_BRACE) {
                    ...
                    nonInitialChunk(processor, yugabyteDBTypeRegistry, content);
                }
                else {
    ...
    protected void nonInitialChunk(ReplicationMessageProcessor processor, YugabyteDBTypeRegistry yugabyteDBTypeRegistry,
                                   final byte[] content)
        ...
        if (firstChar == LEFT_BRACE) {
            ...
            if (currentChunk != null) {
                doProcessMessage(processor, yugabyteDBTypeRegistry, currentChunk, false);
            }
            ...
            // No more changes
            doProcessMessage(processor, yugabyteDBTypeRegistry, currentChunk, true);
    ...
    private void doProcessMessage(ReplicationMessageProcessor processor, YugabyteDBTypeRegistry yugabyteDBTypeRegistry, byte[] content, boolean lastMessage)
            throws IOException, SQLException, InterruptedException {
        if (content != null) {
            ...
            processor.process(new Wal2JsonReplicationMessage(txId, commitTime, change, containsMetadata, lastMessage, yugabyteDBTypeRegistry));
        }
        else {
