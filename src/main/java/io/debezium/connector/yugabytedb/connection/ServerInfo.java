...
public class ServerInfo {
    ...
    protected static class ReplicationSlot {
        ...
        private OpId latestFlushedLsn;
        private OpId restartLsn;
        private Long catalogXmin;

        protected ReplicationSlot(boolean active, OpId latestFlushedLsn, OpId restartLsn, Long catalogXmin) {
            this.active = active;
         ...
         */
        protected OpId latestFlushedLsn() {
