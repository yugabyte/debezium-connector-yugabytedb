...
public interface MessageDecoder {
     ...
     * @param yugabyteDBTypeRegistry - registry with known types
     */
    void processMessage(ByteBuffer buffer, ReplicationMessageProcessor processor, YugabyteDBTypeRegistry yugabyteDBTypeRegistry)
