...
public class WalPositionLocator {
    ...
    private final OpId lastCommitStoredLsn;
    private final OpId lastEventStoredLsn;
    private OpId txStartLsn = null;
    private OpId lsnAfterLastEventStoredLsn = null;
    private OpId firstLsnReceived = null;
    private boolean passMessages = true;
    private OpId startStreamingLsn = null;
    private boolean storeLsnAfterLastEventStoredLsn = false;

    public WalPositionLocator(OpId lastCommitStoredLsn, OpId lastEventStoredLsn) {
     ...
     */
    public Optional<OpId> resumeFromLsn(OpId currentLsn, ReplicationMessage message) {
     ...
     */
    public boolean skipMessage(OpId lsn) {
        if (passMessages) {
            return false;
        }
    ...
    public OpId getLastEventStoredLsn() {
