...
class Wal2JsonReplicationMessage implements ReplicationMessage {
    ...
    public Wal2JsonReplicationMessage(Long transactionId, Instant commitTime, Document rawMessage, boolean hasMetadata, boolean lastEventForLsn,
    ...
    private List<ReplicationMessage.Column> transform(final Document data, final String nameField, final String typeField, final String valueField,
        ...
        for (int i = 0; i < columnNames.size(); i++) {
            ...
            final YugabyteDBType columnType = yugabyteDBTypeRegistry.get(parseType(columnName, columnTypeName));
            ...
            columns.add(new AbstractReplicationMessageColumn(columnName, columnType, columnTypeName, columnOptional, true) {
                ...
                public Object getValue(boolean includeUnknownDatatypes) {
                    return Wal2JsonReplicationMessage.this.getValue(columnName, columnType, columnTypeName, rawValue, includeUnknownDatatypes);
                }
    ...
    private String parseType(String columnName, String typeWithModifiers) {
        ...
        baseType = YugabyteDBTypeRegistry.normalizeTypeName(baseType);
     ...
     * {@link YugabyteDBValueConverter#converter(Column, Field)} instance to match whatever the Connect schema type expects.
     *
     ...
     */
    public Object getValue(String columnName, YugabyteDBType type, String fullType, Value rawValue,
