...
public class SlotState {
    private final OpId latestFlushedLsn;
    private final OpId restartLsn;
    private final Long catalogXmin;
    private final boolean active;

    public SlotState(OpId lastFlushLsn, OpId restartLsn, Long catXmin, boolean active) {
        this.active = active;
     ...
     */
    public OpId slotLastFlushedLsn() {
