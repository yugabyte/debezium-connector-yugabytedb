...
public abstract class RecordsProducer {
    ...
    protected RecordsProducer(YugabyteDBTaskContext taskContext, SourceInfo sourceInfo) {
    ...
    /**
     * Starts up this producer. This is normally done by a {@link YugabyteDBConnectorTask} instance. Subclasses should start
    ...
    /**
     * Requests that this producer be stopped. This is normally a request coming from a {@link YugabyteDBConnectorTask} instance
     */
    ...
    protected TopicNamingStrategy<TableId> topicSelector() {
