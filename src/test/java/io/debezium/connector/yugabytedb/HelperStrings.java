...
public class HelperStrings {
    public static String INSERT_ALL_TYPES = "INSERT INTO all_types (bigintcol, bitcol, varbitcol, booleanval, byteaval, ch, vchar, cidrval, dt, dp, inetval, "
            + "intervalval, jsonval, jsonbval, mc, mc8, mn, nm, rl, si, i4r, i8r, nr, tsr, tstzr, dr, txt, tm, tmtz, ts, tstz, uuidval, txtarr, intarr) VALUES "
            ...
            + "'2021-11-25 12:00:00', '2021-11-25 12:00:00+05:30', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '{\"element1\",\"element2\"}', '{0,1,2}');";
